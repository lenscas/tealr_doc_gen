-- this file holds the etlua implementation
-- It is not written by me, instead all credits go to https://github.com/leafo
-- It is only included in the source as is to make tealr_doc_gen easy to install.
-- The original repo of etlua is at https://github.com/leafo/etlua
local VERSION = "1.3.0"
local insert, concat
do
    local _obj_0 = table
...
do
    ...
    load, setfenv, assert, type, error, tostring, tonumber, setmetatable =
        _obj_0.load, _obj_0.setfenv, _obj_0.assert, _obj_0.type, _obj_0.error,
        _obj_0.tostring, _obj_0.tonumber, _obj_0.setmetatable
end
